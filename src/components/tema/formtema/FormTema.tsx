...
// Componente de formulário para cadastro de temas
function FormTema() {
  ...
  const { id } = useParams<{ id: string }>(); // Pega o ID do tema a partir dos parâmetros da URL
  ...
  // Função para atualizar o estado do tema conforme o usuário digita
  ...
  // Retorna o JSX do componente FormTema
  return (
